...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_post', 'published_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Post.published_at'
        db.alter_column(u'blog_post', 'published_at', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blog_posts'", 'to': u"orm['users.CustomUser']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blog_posts'", 'to': u"orm['blog.Category']"}),
