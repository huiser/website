...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_customuser', (
            ...
            ('mobile_public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ssh_public_key', self.gf('django.db.models.fields.TextField')()),
            ('date_left', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'users', ['CustomUser'])

        # Adding M2M table for field groups on 'CustomUser'
        db.create_table(u'users_customuser_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customuser', models.ForeignKey(orm[u'users.customuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'users_customuser_groups', ['customuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'CustomUser'
        db.create_table(u'users_customuser_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customuser', models.ForeignKey(orm[u'users.customuser'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'users_customuser_user_permissions', ['customuser_id', 'permission_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_customuser_groups')

        # Removing M2M table for field user_permissions on 'CustomUser'
        db.delete_table('users_customuser_user_permissions')
    ...
    models = {
        ...
        u'users.customuser': {
            ...
            'date_left': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'mobile_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'users.websiteuser': {
            ...
            'enddate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2040, 5, 23, 0, 0)'}),
