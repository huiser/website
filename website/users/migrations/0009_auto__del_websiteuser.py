...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'users_websiteuser', (
            ...
            ('startdate', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('enddate', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2040, 5, 23, 0, 0))),
    ...
    models = {
        ...
        u'users.customuser': {
            ...
            'date_left': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2040, 5, 23, 0, 0)'}),
